        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CourseOrGraduationYear = table.Column<string>(type: "character varying(100)", maxLength: 100, nullable: false),
                    About = table.Column<string>(type: "text", nullable: false),
                    Skills = table.Column<string>(type: "text", nullable: false),
                    ProjectExperience = table.Column<string>(type: "text", nullable: false),
                    PortfolioUrl = table.Column<string>(type: "text", nullable: false),
                    GitHubUrl = table.Column<string>(type: "text", nullable: false),
                    ResumeFileUrl = table.Column<string>(type: "text", nullable: false),
                    ...
                    ShowContactsOnlyForVerifiedEmployers = table.Column<bool>(type: "boolean", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CuratorProfiles", x => x.Id);
                    table.ForeignKey(
                        name: "FK_CuratorProfiles_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<Guid>(type: "uuid", nullable: false),
                    SenderApplicantProfileId = table.Column<Guid>(type: "uuid", nullable: false),
                    ReceiverApplicantProfileId = table.Column<Guid>(type: "uuid", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Contacts_ApplicantProfiles_ReceiverApplicantProfileId",
                        column: x => x.ReceiverApplicantProfileId,
                        principalTable: "ApplicantProfiles",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Contacts_ApplicantProfiles_SenderApplicantProfileId",
                        column: x => x.SenderApplicantProfileId,
                        principalTable: "ApplicantProfiles",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Favorites_ApplicantProfiles_ApplicantProfileId",
                        column: x => x.ApplicantProfileId,
                        principalTable: "ApplicantProfiles",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Favorites_EmployerProfiles_EmployerProfileId",
                        column: x => x.EmployerProfileId,
                        principalTable: "EmployerProfiles",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Applications_ApplicantProfileId_OpportunityId",
                table: "Applications",
                columns: new[] { "ApplicantProfileId", "OpportunityId" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Contacts_ReceiverApplicantProfileId",
                table: "Contacts",
                column: "ReceiverApplicantProfileId");

            migrationBuilder.CreateIndex(
                name: "IX_Contacts_SenderApplicantProfileId_ReceiverApplicantProfileId",
                table: "Contacts",
                columns: new[] { "SenderApplicantProfileId", "ReceiverApplicantProfileId" });

            migrationBuilder.CreateIndex(
                name: "IX_CuratorProfiles_UserId",
                table: "CuratorProfiles",
                column: "UserId",
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Favorites_ApplicantProfileId_EmployerProfileId",
                table: "Favorites",
                columns: new[] { "ApplicantProfileId", "EmployerProfileId" });

            migrationBuilder.CreateIndex(
                name: "IX_Favorites_ApplicantProfileId_OpportunityId",
                table: "Favorites",
                columns: new[] { "ApplicantProfileId", "OpportunityId" });

            migrationBuilder.CreateIndex(
                name: "IX_Favorites_EmployerProfileId",
                table: "Favorites",
